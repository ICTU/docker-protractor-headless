...
ENV CHROME_PACKAGE="google-chrome-stable_67.0.3396.79-1_amd64.deb" NODE_PATH=/usr/local/lib/node_modules:/protractor/node_modules
RUN npm install -g protractor@5.3.0 minimist@1.2.0 && \
